...
class Player:
    ...
    def __init__(self, name: str, color: str = None):
        ...
        self.oil = 0
        # CATAN: New Energies only: energy generated by this player's power
        # plants. Held in front of the player (always public), capped at 5, and
        # kept apart from resources because it is spent on its own actions, is
        # never counted toward the discard limit on a 7, and is never stolen or
        # traded at a harbour (New Energies rulebook, 'Energy uses', p. 15).
        # Zero off the scenario.
        self.energy = 0
