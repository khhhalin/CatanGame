/*
 * Socket.IO client, vendored so the game runs offline and depends on no CDN.
 *
 * Version:  4.7.2 (unmodified upstream build, MIT, minus its sourceMappingURL)
 * Source:   https://cdnjs.cloudflare.com/ajax/libs/socket.io/4.7.2/socket.io.min.js
 * sha256:   83df4abc7eec941f1d29ae254e80bac0bb82d398fbe2e8ee4ea2a7efc8e704f1
 *
 * WHY THIS VERSION: it must speak the same Engine.IO wire protocol as the
 * server. This build sends `EIO=4`, and engineio/server.py rejects anything
 * that is not '4'. The server side is python-socketio 5.16.3 /
 * python-engineio 4.13.4, whose supported client is Socket.IO JS 4.x.
 *
 * TO UPGRADE: take a 4.x build, confirm it still requests `EIO=4`, and
 * update the version, URL and hash above. Do not cross to a 5.x client
 * without checking the protocol the pinned python-engineio accepts.
 */
/*!
 * Socket.IO v4.7.2
